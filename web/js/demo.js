...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__kso__ = __webpack_require__(16);

function alert(text) {
    __WEBPACK_IMPORTED_MODULE_0__kso__["call"]('showAlert', {
        text: text
    });
}
...
/* harmony export (immutable) */ __webpack_exports__["bind2"] = bind2;
/* harmony export (immutable) */ __webpack_exports__["off2"] = off2;
/* harmony export (immutable) */ __webpack_exports__["getUserInfo"] = getUserInfo;
/* harmony export (immutable) */ __webpack_exports__["getAppId"] = getAppId;
/* harmony export (immutable) */ __webpack_exports__["getFullName"] = getFullName;
/* harmony export (immutable) */ __webpack_exports__["getCustomDocumentProperty"] = getCustomDocumentProperty;
/* harmony export (immutable) */ __webpack_exports__["setCustomDocumentProperty"] = setCustomDocumentProperty;
/* harmony export (immutable) */ __webpack_exports__["getStorageDir"] = getStorageDir;
/* harmony export (immutable) */ __webpack_exports__["fileRename"] = fileRename;
/* harmony export (immutable) */ __webpack_exports__["fileCopy"] = fileCopy;
/* harmony export (immutable) */ __webpack_exports__["fileDelete"] = fileDelete;
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppInfo", function() { return AppInfo; });
/* harmony export (immutable) */ __webpack_exports__["getAppInfo"] = getAppInfo;
/* harmony export (immutable) */ __webpack_exports__["getFileId"] = getFileId;
/* harmony export (immutable) */ __webpack_exports__["setFileId"] = setFileId;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_js_base64__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__storage__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__msg__ = __webpack_require__(11);
...
var eventMap = {
    selectionChange: {
        start: 'connectSelectionChange',
        end: 'disConnectSelectionChange',
        callback: 'onSheetSelectionChange',
        context: {}
    },
    cellValueChange: {
        start: 'connectCellChange',
        end: 'disConnectCellChange',
        callback: 'onCellChange',
        context: {}
    },
    workbookActivate: {
        start: 'connectWorkbookActivate',
        end: 'disConnectWorkbookActivate',
        callback: 'onWorkbookActivate',
        context: {}
    }
};
var eventHub = {};
function call(methodName, args) {
    return new Promise(function (resolve, reject) {
        try {
            var callbackName_1 = methodName + '_async_callback_' + ++jsAsynCallCallbackCount;
            var invokeParams = {
                method: methodName,
                params: args,
                callback: callbackName_1
            };
            window[callbackName_1] = function (res) {
                delete window[callbackName_1];
                var result = JSON.parse(__WEBPACK_IMPORTED_MODULE_0_js_base64__["Base64"].decode(res));
                resolve(result);
            };
            var jsonIn = __WEBPACK_IMPORTED_MODULE_0_js_base64__["Base64"].encode(JSON.stringify(invokeParams));
            if (_cefQuery) {
                _cefQuery({
            ...
            __WEBPACK_IMPORTED_MODULE_2__msg__["a" /* alert */](error);
        }
    });
}
function on(event, callback) {
    call(eventMap[event].start, { context: 1 }).then(function () {
        window[eventMap[event].callback] = function (res) {
            delete window[eventMap[event].callback];
            var result = JSON.parse(__WEBPACK_IMPORTED_MODULE_0_js_base64__["Base64"].decode(res));
            callback(result);
            if (eventMap[event].end) {
                call(eventMap[event].end, { context: 1 });
            }
            delete eventHub[event];
        };
    });
}
...
function bind2(event, context, callback) {
    if (!context) {
        return;
    }
    eventMap[event].context[context] = true;
    call(eventMap[event].start, { context: context }).then(function () {
        window[eventMap[event].callback] = function (res) {
            var result = JSON.parse(__WEBPACK_IMPORTED_MODULE_0_js_base64__["Base64"].decode(res));
            if (result.context && true === eventMap[event].context[result.context]) {
                callback(result);
            }
        };
    });
}
function off2(event, context) {
    if (context) {
        eventMap[event].context[context] = false;
    }
}
function getUserInfo() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, call('getUserInfo', {})];
                case 1:
                    result = _a.sent();
                    if (result.callstatus === 'ok') {
                        return [2, JSON.parse(result.result)];
                    }
                    return [2];
            }
        });
...
function getFullName() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, call('getFullName', {})];
                case 1:
                    result = _a.sent();
                    if (result.callstatus === 'ok') {
                        return [2, result.result];
...
function getCustomDocumentProperty(name) {
    return __awaiter(this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, call('getCustomDocumentProperty', {
                        name: name
                    })];
                case 1:
                    result = _a.sent();
...
function setCustomDocumentProperty(name, value) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, call('setCustomDocumentProperty', {
                        name: name,
                        value: value
                    })];
                case 1:
...
function getStorageDir() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, call('getStorageDir', {})];
                case 1:
                    result = _a.sent();
                    return [2, result.result];
            }
...
function fileRename(source, target) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, call('fileRename', { source: source, target: target })];
                case 1:
                    result = _a.sent();
                    return [2];
            }
...
function fileCopy(source, target) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, call('fileCopy', { source: source, target: target })];
                case 1:
                    result = _a.sent();
                    return [2];
            }
...
function fileDelete(file) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, call('getStorageDir', { file: file })];
                case 1:
                    result = _a.sent();
                    return [2];
            }
...
function getAppInfo() {
    return __awaiter(this, void 0, void 0, function () {
        var appInfo, userinfo, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    appInfo = __WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].appInfo;
                    if (!appInfo) {
                        appInfo = new AppInfo();
                        __WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].appInfo = appInfo;
                    }
                    if (!!appInfo.uid) return [3, 2];
                    return [4, getUserInfo()];
                case 1:
                    userinfo = _c.sent();
                    if (null == userinfo || userinfo["logined"] != true) {
                        throw "用户未登录";
                    }
                    appInfo.uid = userinfo["user_id"];
                    _c.label = 2;
                case 2:
                    if (!!appInfo.appid) return [3, 4];
                    _a = appInfo;
                    return [4, getAppId()];
                case 3:
                    _a.appid = _c.sent();
                    ...
                    _c.label = 4;
                case 4:
                    if (!!appInfo.defaultPath) return [3, 6];
                    _b = appInfo;
                    return [4, getStorageDir()];
                case 5:
                    _b.defaultPath = _c.sent();
                    _c.label = 6;
                case 6: return [2, appInfo];
            }
        });
    });
}
function getFileId(createIfNotExists) {
    return __awaiter(this, void 0, void 0, function () {
        var appInfo, key, fileId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, getAppInfo()];
                case 1:
                    appInfo = _a.sent();
                    key = appInfo.appid + "_" + appInfo.uid + "_fileId";
                    return [4, getCustomDocumentProperty(key)];
                case 2:
                    fileId = _a.sent();
                    if (!(true == createIfNotExists)) return [3, 4];
                    if (!!fileId) return [3, 4];
                    fileId = __WEBPACK_IMPORTED_MODULE_3__utils__["b" /* uuid */]();
                    return [4, setCustomDocumentProperty(key, fileId)];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4: return [2, fileId];
            }
        });
    });
}
...
function distinct(arr, fromIndex) {
    var newArray = Array();
    var _loop_1 = function (i) {
        if (newArray.findIndex(function (n) { return n === arr[i]; }) < 0) {
            newArray.push(arr[i]);
        }
    };
...
*/
var ba=__webpack_require__(2),ea=__webpack_require__(0),m=__webpack_require__(12),A=__webpack_require__(5),C=__webpack_require__(3),fa=__webpack_require__(13),ha=__webpack_require__(14),ja=__webpack_require__(15),ka=__webpack_require__(6);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["c"] = getCellValue;
/* harmony export (immutable) */ __webpack_exports__["l"] = setCellValue;
/* harmony export (immutable) */ __webpack_exports__["d"] = getCellsValue;
/* unused harmony export getUsedRange */
/* unused harmony export getUserRangeAddress */
/* harmony export (immutable) */ __webpack_exports__["g"] = hasMergerCells;
/* unused harmony export setRangeValidation */
/* harmony export (immutable) */ __webpack_exports__["i"] = openFileDialog;
/* harmony export (immutable) */ __webpack_exports__["h"] = openFile;
/* unused harmony export openTemplateFile */
/* unused harmony export Range */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EnumCell; });
/* harmony export (immutable) */ __webpack_exports__["k"] = saveExcel;
/* harmony export (immutable) */ __webpack_exports__["e"] = getWorkbookName;
/* harmony export (immutable) */ __webpack_exports__["j"] = renameWorkbook;
/* harmony export (immutable) */ __webpack_exports__["f"] = getWorksheetName;
/* harmony export (immutable) */ __webpack_exports__["b"] = activeSheet;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__kso__ = __webpack_require__(16);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, __WEBPACK_IMPORTED_MODULE_0__kso__["call"]('getSheetValue', {
                            range: address
                        })];
                case 1:
                    result = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, __WEBPACK_IMPORTED_MODULE_0__kso__["call"]('setSheetValue', {
...
function getCellsValue(column, start, end) {
    return __awaiter(this, void 0, void 0, function () {
        var values, i, range, result, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
...
function getUsedRange() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, __WEBPACK_IMPORTED_MODULE_0__kso__["call"]('getUsedRangeAddress', {})];
                case 1:
                    result = _a.sent();
                    return [2, new Range(result.result)];
            }
        });
    });
}
function getUserRangeAddress() {
    return __awaiter(this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function hasMergerCells(address) {
    return __awaiter(this, void 0, void 0, function () {
        var result, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, __WEBPACK_IMPORTED_MODULE_0__kso__["call"]('hasMergerCells', { address: address })];
                case 1:
                    result = _a.sent();
                    return [2, result.callstatus === 'ok' && !(false == result.result)];
                case 2:
                    error_4 = _a.sent();
                    alert(error_4);
                    return [3, 3];
...
function setRangeValidation(rangeAddress, values) {
    return __awaiter(this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, __WEBPACK_IMPORTED_MODULE_0__kso__["call"]('setRangeValidation', {
...
function openFileDialog(title) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2, __WEBPACK_IMPORTED_MODULE_0__kso__["call"]('openFileDialog', {
                    title: title,
                    desc: '',
                    suffix: '*.*'
                })];
...
function openFile(filepath) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, __WEBPACK_IMPORTED_MODULE_0__kso__["call"]('openExcel', { filepath: filepath })];
                case 1:
                    result = _a.sent();
                    if (result.callstatus !== 'ok' || false == result.result) {
                        throw "文件打不开";
                    }
                    return [2];
            }
...
function openTemplateFile(filepath) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, __WEBPACK_IMPORTED_MODULE_0__kso__["call"]('openExcelTemp', {
                        filepath: filepath
                    })];
...
var Range = (function () {
    function Range(rangeAddress) {
        rangeAddress = rangeAddress.replace(/\$/g, '');
        var array = rangeAddress.toUpperCase().split(':');
        var col1 = array[0].replace(/[\d]+/g, '');
        var row1 = array[0].replace(col1, '');
        if (!col1 && !row1) {
            throw "区域字符串错误";
        }
        var col2 = col1;
        var row2 = row1;
        if (array.length >= 2) {
            col2 = array[1].replace(/[\d]+/g, '');
            row2 = array[1].replace(col2, '');
        }
        this.isCol = this.isRow = false;
        if (!row1 || !row2) {
            this.isCol = true;
            this.beginRow = 1;
            this.endRow = 1048576;
            ...
            this.beginRow = parseInt(row1);
            this.endRow = parseInt(row2);
        }
        if (!col1 || !col2) {
            this.isRow = true;
            this.beginCol = 1;
            ...
            this.beginCol = Range.toColNumber(col1);
            this.endCol = Range.toColNumber(col2);
        }
        if (this.beginRow > this.endRow) {
            __WEBPACK_IMPORTED_MODULE_1__utils__["a" /* exchange */](this.beginRow, this.endRow);
        }
        if (this.beginCol > this.endCol) {
            __WEBPACK_IMPORTED_MODULE_1__utils__["a" /* exchange */](this.beginCol, this.endCol);
        }
        if (true == this.isCol && true == this.isRow) {
            this.address = "1:1048576";
        }
        else if (true == this.isCol) {
            this.address = Range.toColString(this.beginCol) + ":" + Range.toColString(this.endCol);
        }
        else if (true == this.isRow) {
            this.address = "" + this.beginRow + ":" + this.endRow;
        }
        else {
            this.address = Range.toColString(this.beginCol) + this.beginRow;
            if (this.beginRow != this.endRow || this.beginCol != this.endCol) {
                this.address = this.address + ":" + Range.toColString(this.endCol) + this.endRow;
            }
        }
    }
    ...
    Range.prototype.getColCount = function () {
        return this.endCol - this.beginCol + 1;
    };
    Range.prototype.isCell = function () {
        return this.beginCol == this.endCol && this.beginRow == this.endRow;
    };
    Range.prototype.contains = function (range) {
        return this.beginRow <= range.beginRow && this.beginCol <= range.beginCol &&
            this.endRow >= range.endRow && this.endCol >= range.endCol;
    };
    Range.prototype.intersected = function (range) {
        return Math.min(this.endRow, range.endRow) >= Math.max(this.beginRow, range.beginRow) &&
            Math.min(this.endCol, range.endCol) >= Math.max(this.beginCol, range.beginCol);
    };
    Range.prototype.makeCell = function (row, col) {
        this.beginRow = this.endRow = row;
        this.beginCol = this.endCol = col;
        this.isRow = false;
        this.isCol = false;
        this.address = Range.toColString(this.beginCol) + this.beginRow;
    };
    Range.toColNumber = function (colString) {
        var num = 0;
        var A = 'A'.charCodeAt(0);
        for (var i = 0; i < colString.length; ++i) {
            num = num * 26 + colString.charCodeAt(i) - A + 1;
        }
        return num;
    };
    Range.toColString = function (colNumber) {
        var num = colNumber;
        var str = '';
        var A = 'A'.charCodeAt(0);
        while (num > 0) {
            str = String.fromCharCode(A + (num - 1) % 26) + str;
            num = Math.floor((num - 0.1) / 26);
        }
        return str;
    };
    Range.toRangeAddress = function (beginRow, beginCol, endRow, endCol) {
        return Range.toColString(beginCol) + beginRow + ":" + Range.toColString(endCol) + endRow;
    };
    return Range;
}());
...
var EnumCell = (function (_super) {
    ...
    function EnumCell(RangeAddress, isRowFirst) {
        var _this = _super.call(this, RangeAddress) || this;
        _this._isRowFirst = false;
        _this._isRowFirst = isRowFirst;
        _this.row = _this.beginRow;
        _this.col = _this.beginCol;
        _this.address = Range.toColString(_this.col) + _this.row;
        return _this;
    }
    EnumCell.prototype.hasNext = function () {
        return this.row < this.endRow || this.col < this.endCol;
    };
    EnumCell.prototype.next = function () {
        if (true == this._isRowFirst) {
            this.row++;
            ...
            if (this.col > this.endCol) {
                this.col = this.beginCol;
                this.row++;
            }
        }
        this.address = Range.toColString(this.col) + this.row;
        return this.address;
    };
    EnumCell.prototype.getRow = function (rowOffset) {
        var row = new EnumCell('A1', false);
        row._isRowFirst = this._isRowFirst;
        row.beginCol = this.beginCol;
        row.beginRow = this.beginRow + rowOffset;
        row.endCol = this.endCol;
        row.endRow = row.beginRow;
        row.row = row.beginRow;
        row.col = row.beginCol;
        row.address = Range.toColString(row.col) + row.row;
        return row;
    };
    return EnumCell;
}(Range));
...
function saveExcel() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, __WEBPACK_IMPORTED_MODULE_0__kso__["call"]('saveExcel', {})];
                case 1:
                    _a.sent();
                    return [2];
            }
...
function getWorkbookName() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, __WEBPACK_IMPORTED_MODULE_0__kso__["call"]('getWorkbookName', {})];
                case 1:
                    result = _a.sent();
                    if (result.callstatus === 'ok') {
                        return [2, result.result];
...
function renameWorkbook(name) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, __WEBPACK_IMPORTED_MODULE_0__kso__["call"]('renameWorkbook', { name: name })];
                case 1: return [2, _a.sent()];
            }
        });
    });
...
function getWorksheetName() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, __WEBPACK_IMPORTED_MODULE_0__kso__["call"]('getWorksheetName', {})];
                case 1:
                    result = _a.sent();
                    if (result.callstatus === 'ok') {
                        return [2, result.result];
...
function activeSheet(sheetName) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, __WEBPACK_IMPORTED_MODULE_0__kso__["call"]('activeSheet', { name: sheetName })];
                case 1: return [2, _a.sent()];
            }
        });
    });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__libs_kso__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__libs_sheet__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__libs_msg__ = __webpack_require__(11);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var App = (function (_super) {
    ...
    App.prototype.render = function () {
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { style: { borderWidth: '1px', borderStyle: 'solid', padding: '5px' } },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("h2", null, "\u6F14\u793Ademo"),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null,
                "\u6267\u884C\u7ED3\u679C\uFF1A",
                this.state.result),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { onClick: this.getCellValue.bind(this) }, "\u83B7\u53D6A1\u5355\u5143\u683C\u7684\u503C"),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { onClick: this.selectCell.bind(this) }, "\u9009\u4E2DE5\u5355\u5143\u683C"),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { onClick: this.getCellsValue.bind(this) }, "\u83B7\u53D6A1-A10\u5355\u5143\u683C\u7684\u503C"),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { onClick: this.getSelection.bind(this) }, "\u83B7\u53D6\u5F53\u524D\u9009\u4E2D\u7684\u5355\u5143\u683C"),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { onClick: this.openFile.bind(this) }, "\u5206\u6790\u8868\u5934"),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { onClick: this.test.bind(this) }, "test"),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { onClick: this.alertModal.bind(this) }, "\u5F39\u51FA\u6846")));
    };
    App.prototype.alertModal = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, __WEBPACK_IMPORTED_MODULE_2__libs_kso__["call"]('navigateOnNewWidget')];
                    case 1:
                        result = _a.sent();
                        return [3, 3];
                    case 2:
    ...
    App.prototype.getCellValue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, __WEBPACK_IMPORTED_MODULE_2__libs_kso__["call"]('getSheetValue', {
                            range: 'A1'
                        })];
                    case 1:
                        result = _a.sent();
    ...
    App.prototype.selectCell = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, __WEBPACK_IMPORTED_MODULE_2__libs_kso__["call"]('selectCell', {
                            range: 'E5'
                        })];
                    case 1:
                        result = _a.sent();
    ...
    App.prototype.getSelection = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, __WEBPACK_IMPORTED_MODULE_2__libs_kso__["call"]('getSelection')];
                    case 1:
                        result = _a.sent();
                        if (result.callstatus === 'ok') {
                            this.setState({
    ...
    App.prototype.getCellsValue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, __WEBPACK_IMPORTED_MODULE_3__libs_sheet__["d" /* getCellsValue */]('A', 1, 10)];
                    case 1:
                        result = _a.sent();
                        this.setState({
                            result: result.join(', ')
    ...
    App.prototype.openFile = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2];
            });
    ...
    App.prototype.test = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                __WEBPACK_IMPORTED_MODULE_4__libs_msg__["a" /* alert */]("test alert");
                return [2];
            });
        });
    };
...
/***/ })
/******/ ]);
//# sourceMappingURL=demo.js.map?v=201805281102